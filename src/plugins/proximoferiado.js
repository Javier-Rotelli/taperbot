  ...
  emitter.on("received:message", (message) => {
    ...
    const feriados2022 = [
      ...
      },
      {
        ...
        weekday: "lunes",
        nextTo:
          "4 días no laborables, desde el sábado 26 de febrero hasta el martes 1 de marzo",
      },
      {
        date: "2022-03-01",
        name: "Feriado de carnaval",
      ...
      },
      {
        ...
        weekday: "viernes",
        nextTo:
          "4 días no laborables, desde el viernes 17 hasta el lunes 20 inclusive",
      },
      {
        date: "2022-06-20",
      ...
      },
      {
        ...
        weekday: "lunes",
        nextTo:
          "3 días no laborables, desde el sábado 13, hasta el lunes 15 inclusive",
      },
      {
        date: "2022-10-07",
        ...
        weekday: "viernes",
        nextTo:
          "4 días no laborables, desde el viernes 7 hasta el lunes 10 inclusive",
      },
      {
        date: "2022-10-10",
    ...
    const nextFeriado = feriados2022.find(
      (_) =>
    ...
    if (nextFeriado) {
      ...
      responseText +=
        " [Agregar a Google Calendar](https://www.google.com/calendar/render?action=TEMPLATE&text=" +
        nextFeriado.name.replace(/ /g, "%20") +
        "&dates=" +
        theFeriadoDate.format("YYYYMMDD") +
        "%2F" +
